...
Ensure all findings are traceable to the provided framework requirements.`;
    ...
    try {
      ...
      console.log('🤖 Policy analysis generated by AI');

      return this.parsePolicyAnalysisResponse(response.content as string, requirements);
...
Ensure the policy is implementation-ready and addresses all framework requirements.`;
    ...
    try {
      ...
      console.log('🤖 Policy generated by AI');
