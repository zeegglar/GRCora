  ...
  return (
    <div className="flex-1 p-8 overflow-y-auto">
      <header className="mb-8">
        ...
        <p className="text-muted mt-1">Welcome back, <span className="text-heading text-2xl font-black">{user.name}</span>. Here's the status of the <span className="text-muted text-lg font-medium">"{project.name}"</span> engagement.</p>
      </header>
      <main>
